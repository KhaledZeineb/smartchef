...
class DashboardController extends AbstractController
{
    ...
    #[IsGranted('ROLE_USER')]
    public function generateRecipe(Request $request, UserIngredientRepository $userIngredientRepository, OpenAIService $openAIService): Response
    {
        $user = $this->getUser();
        $userIngredients = $userIngredientRepository->findBy(['user' => $user]);
        ...
        $recipe = $openAIService->generateRecipe($userIngredients);
